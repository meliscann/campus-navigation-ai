...
from search.common import failure  # failure node kontrolü için
...
def compute_path_cost(problem, path):
    ...
    for i in range(len(path) - 1):
        ...
        # Find the action that moves from s1 to s2
        found = False
...
def main():
    ...
    if ucs_path:
        ...
        print("Cost :", ucs_goal.path_cost)  # UCS cost is path_cost
        print("Path :", ucs_path)
    ...
    if astar_path:
        ...
        print("Cost :", astar_goal.path_cost)  # A* cost is path_cost
